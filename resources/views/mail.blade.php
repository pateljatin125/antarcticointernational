...
<head>
    ...
    <title>Antarctico International</title>
    <style type="text/css">
                                    ...
                                    <td class="movableContentContainer bgItem">
                                                    ...
                                                    <td width="200" valign="top" align="center">
                                                        <div class="contentEditableContainer contentImageEditable">
                                                            <div class="contentEditable" align="center">
                                                                <img src="asset('/assets/image/Logo-Image.JPG')"
                                                                    width="155" height="155" alt="Logo"
                                        ...
                                        <div class="movableContent">
                                                ...
                                                <tr>
                                                    <td width="100%" colspan="3" align="center"
                                                        ...
                                                        <div class="contentEditableContainer contentTextEditable">
                                                            <div class="contentEditable" align="center">
                                                                <h2>Antarctico International</h2>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <div class="contentEditableContainer contentTextEditable">
                                                            <div class="contentEditable" align="left">
                                                                ...
                                                                <p style="padding-left: 10%;">{{ $details['message'] }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" class="container">
                                                <tr>
                                                    <td width="200" style="padding-top:25px;">
                                                ...
                                                <tr>
                                                    <td width="60%" height="70" valign="middle"
                                                        ...
                                                        <div class="contentEditableContainer contentTextEditable">
                                                            <div class="contentEditable" align="left">
                                                                <span
                                                                    style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">Antarctico
                                                                    International</span>
                                                                <br />
                                                            </div>
                                                        </div>
